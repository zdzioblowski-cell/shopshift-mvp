...
engine.js — niezależny silnik ekonomii; app.js — interfejs i zapis; scene.js — grafika Canvas; feedback.js — formularze opinii; style.css — wygląd. npm test uruchamia 25 testów ekonomii, w tym pełną symulację 30 dni. Node.js 18 lub nowszy wymagany tylko do testów i opcjonalnego lokalnego serwera.
...
## Wersja 0.4.0 — sklep działa na żywo

Zamówienia klientów: losowe odstępy 10–50 sekund. Towar można zamawiać w każdej fazie; każdy zakup przyjeżdża po losowych 1–5 minutach aktywnej gry. Przed startem kampanii warto poczekać na pierwszą dostawę. Brak towaru przy nadejściu klienta oznacza utracone zamówienie. Pula ruchu nadal powstaje przy otwarciu dnia.
...
Przyciski nad magazynem: Zamów towar, Zmień ceny, Promocje, Marketing. Ceny, rabaty i darmową dostawę można zmieniać podczas sprzedaży; nowe ustawienia dotyczą kolejnych zamówień. Przyjęte zamówienia zachowują warunki zakupu. Budżety kampanii i koszty stałe nadal ustala się przed otwarciem dnia.
